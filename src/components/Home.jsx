    ...
    <div className="bg-white grid place-items-center">
        ...
        <div className="w-[848px] h-[465px] relative">
          ...
          <div className="h-14 px-6 py-4 left-[375px] top-[259px] absolute bg-stone-700 rounded-full inline-flex justify-center items-center">
            <div className="flex justify-center items-center gap-3">
              <button className="justify-start text-white text-lg font-extrabold font-['Urbanist']">
                Ngobrol yuk
              </button>
      ...
      <section className="w-[1343px] h-[557px] relative bg-stone-100 mt-16 mb-8">
        ...
        <div className="w-[594px] h-72 left-[64px] top-[126px] absolute">
          ...
          <div className="w-72 h-11 left-[220px] top-[209px] absolute bg-rose-100 rounded-[40px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] border border-amber-700" />
          <div className="size-36 left-[36px] top-[63px] absolute bg-zinc-300 rounded-full" />
          <div className="w-96 h-20 left-[178px] top-[95px] absolute text-center justify-start text-black text-2xl font-semibold font-['Sora'] leading-9 tracking-tight">
            "Kamu tidak sendiri. Pulih bisa dimulai dari sini"
          </div>
          <div className="w-40 h-9 left-[284px] top-[213px] absolute text-center justify-start text-black text-2xl font-semibold font-['Sora'] leading-9 tracking-tight">
            Lihat detail
          </div>
        </div>
